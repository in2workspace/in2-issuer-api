...
import es.in2.issuer.shared.application.workflow.NonceValidationWorkflow;
...
import static es.in2.issuer.backoffice.domain.util.Constants.SUPPORTED_PROOF_ALG;
import static es.in2.issuer.backoffice.domain.util.Constants.SUPPORTED_PROOF_TYP;
