...
import es.in2.issuer.shared.domain.exception.DidKeyCreationException;
import es.in2.issuer.shared.domain.exception.ECKeyCreationException;
import es.in2.issuer.shared.domain.util.UVarInt;
