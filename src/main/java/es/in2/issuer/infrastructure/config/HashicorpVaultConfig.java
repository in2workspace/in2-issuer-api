...
import es.in2.issuer.infrastructure.config.properties.HashicorpVaultProperties;
...
public class HashicorpVaultConfig extends AbstractReactiveVaultConfiguration {
    ...
    public VaultEndpoint vaultEndpoint() {
        VaultEndpoint endpoint = VaultEndpoint.create(properties.host(), Integer.parseInt(properties.port()));
        endpoint.setScheme(properties.scheme());
        return endpoint;
    }
