...
public interface VerifiableCredentialService {
    Mono<String> generateVc(String processId, String vcType, IssuanceRequest issuanceRequest);
    Mono<String> generateVerifiableCertification(String processId, String vcType, IssuanceRequest issuanceRequest);
