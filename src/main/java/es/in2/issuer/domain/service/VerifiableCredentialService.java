...
public interface VerifiableCredentialService {
    Mono<String> generateVc(String processId, String vcType, CredentialData credentialData);
    Mono<String> generateVerifiableCertification(String processId, String vcType, CredentialData credentialData);
