...
import es.in2.issuer.backoffice.domain.exception.CredentialTypeUnsupportedException;
...
import static es.in2.issuer.backoffice.domain.util.Constants.VERIFIABLE_CERTIFICATION;
