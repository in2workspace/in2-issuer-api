...
import es.in2.issuer.backoffice.domain.exception.JWTClaimMissingException;
import es.in2.issuer.backoffice.domain.exception.JWTCreationException;
import es.in2.issuer.backoffice.domain.exception.JWTParsingException;
import es.in2.issuer.shared.domain.service.JWTService;
import es.in2.issuer.backoffice.infrastructure.crypto.CryptoComponent;
...
import static es.in2.issuer.backoffice.domain.util.Constants.DID_KEY;
