//package es.in2.issuer.url.service.impl;
//
//import com.fasterxml.jackson.core.JsonProcessingException;
//import com.fasterxml.jackson.databind.ObjectMapper;
//import es.in2.issuer.url.exception.AuthenticSourcesUserParsingException;
//import es.in2.issuer.url.exception.ParseErrorException;
//import es.in2.issuer.url.model.CommitCredential;
//import es.in2.issuer.url.model.SubjectDataResponse;
//import es.in2.issuer.url.service.AuthenticSourcesRemoteService;
//import es.in2.issuer.url.util.HttpUtils;
...
//    private final String authenticSourcesBaseUrl;
//
//    public AuthenticSourcesRemoteServiceImpl(AuthenticSourcesProperties authenticSourcesProperties, ApiConfig apiConfig, ObjectMapper objectMapper, HttpUtils httpUtils) {
//        this.authenticSourcesBaseUrl = apiConfig.getAuthenticSourcesDomain();
...
//                    // Read the content of the file and convert JSON content to AuthenticSourcesGetUserResponseDTO object
//                    new String(userLocalFileData.getInputStream().readAllBytes(), StandardCharsets.UTF_8)
//
//                )
