...
CREATE TABLE IF NOT EXISTS credentials.cloud_provider (
...
CREATE TABLE IF NOT EXISTS credentials.signature_configuration (
...
CREATE TABLE IF NOT EXISTS credentials.signature_configuration_audit (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS credentials.configuration (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    organization_identifier VARCHAR(255) NOT NULL,
