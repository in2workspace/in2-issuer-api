...
class CredentialRequestTest {
    ...
    void testConstructorAndGetters() {
        ...
        // Act
        CredentialRequest credentialRequest = new CredentialRequest(expectedFormat, expectedCredentialDefinition,"LEARCredentialEmployee", expectedProof);
        // Assert
    ...
    void lombokGeneratedMethodsTest() {
        ...
        CredentialDefinition expectedCredentialDefinition = new CredentialDefinition(List.of("type"));
        // Act
        CredentialRequest dto1 = new CredentialRequest(expectedFormat, expectedCredentialDefinition, "LEARCredentialEmployee", expectedProof);
        CredentialRequest dto2 = new CredentialRequest(expectedFormat, expectedCredentialDefinition, "LEARCredentialEmployee", expectedProof);
        // Assert
