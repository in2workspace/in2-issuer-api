...
class M2MTokenServiceImplIntegrationTest {
    ...
    private static @NotNull VerifierConfig getVerifierConfig() {
        ...
        VerifierProperties verifierProperties = new VerifierProperties(
                ...
                new VerifierProperties.Crypto("83bd452e1e9536d244d9a440edd282d96738d9409b9168204377b5e1bba40329"),new VerifierProperties.ClientAssertion(new VerifierProperties.Token("DAYS","30")), new VerifierProperties.Paths("/.well-known/openid-configuration"));
