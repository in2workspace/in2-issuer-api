...
import es.in2.issuer.backend.backoffice.domain.exception.VcTemplateDoesNotExistException;
import es.in2.issuer.backend.backoffice.domain.model.dto.VcTemplate;
import es.in2.issuer.backend.backoffice.domain.service.CredentialSchemaService;
import es.in2.issuer.backend.backoffice.infrastructure.controller.CredentialSchemaController;
