...
import static es.in2.issuer.backend.domain.util.Constants.SIGNATURE_REMOTE_TYPE_SERVER;
...
class RemoteSignaturePropertiesTest {
    ...
    void testRemoteSignatureProperties() {
        ...
        RemoteSignatureProperties remoteSignatureProperties = new RemoteSignatureProperties(SIGNATURE_REMOTE_TYPE_SERVER,"url", paths, "clientId", "clientSecret", "credentialId", "credentialPassword");

        assertEquals(SIGNATURE_REMOTE_TYPE_SERVER, remoteSignatureProperties.type());
        assertEquals("url", remoteSignatureProperties.url());
