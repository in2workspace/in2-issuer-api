...
class AuthServerConfigTest {
    ...
    void setUp() {
        ...
        lenient().when(authServerProperties.externalUrl()).thenReturn("externalUrl");
        lenient().when(authServerProperties.internalUrl()).thenReturn("internalUrl");
    ...
    void testGetAuthServerInternalDomain() {
        ...
        assertEquals("internalUrl", result);
    }
