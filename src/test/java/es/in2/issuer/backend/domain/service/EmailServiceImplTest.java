...
import es.in2.issuer.backend.domain.service.impl.EmailServiceImpl;
...
class EmailServiceImplTest {
    ...
    void testSendPendingSignatureCredentialNotification(){
        ...
        Mono<Void> result = emailService.sendPendingSignatureCredentialNotification("to@example.com", "subject", "\"John\"", "url");
