...
import es.in2.issuer.backoffice.infrastructure.config.properties.AuthServerProperties;
...
class AuthServerConfigTest {
    ...
    void setUp() {
        ...
        lenient().when(authServerProperties.externalDomain()).thenReturn("externalDomain");
        lenient().when(authServerProperties.internalDomain()).thenReturn("internalDomain");
